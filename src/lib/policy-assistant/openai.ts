...
function buildSystemPrompt(): string {
  return [
    ...
    "3) List each relevant policy in that section and include these labels exactly for each policy:",
    "Policy Section:",
    "Policy Code:",
    ...
    "Policy Title:",
    "Policy Wording:",
    "4) If Date of Policy Revision Date is blank, write: No Policy Revisions",
    "5) If Policy Wording is summarized, include this sentence within that section:",
    "This is a summary of the policy",
    "6) Do not include action plans inside individual policy blocks.",
    "7) After all relevant policy blocks, include exactly one section titled: Action Steps:",
    "8) Action Steps must be one unified numbered plan that integrates all listed policies.",
    "9) Include a section titled: Legal, Ethical, and Academic Implications:",
    `10) End every response with this exact bold disclaimer: ${REQUIRED_DISCLAIMER}`,
    "11) Never include opening greeting text in the response.",
    "12) Never present legal advice. Always present guidance only.",
  ].join("\n");
}
