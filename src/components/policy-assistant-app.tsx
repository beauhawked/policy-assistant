...
export function PolicyAssistantApp() {
      ...
      <div className="piq-split">
        <aside className="piq-split-brand">
          <span className="piq-brand">
            ...
            <span className="piq-brand-word">Policy Aligned</span>
          </span>
  ...
  const rail = (
    <nav className="piq-rail" aria-label="Primary">
      <Link className="piq-brand-mark piq-rail-mark" href="/" aria-label="Policy Aligned home">
        <Image src="/logo-icon.png" alt="" width={32} height={27} className="piq-brand-logo" />
      </Link>
  ...
  const mobileHeader = (
    <header className="piq-mobile-header">
      <Link className="piq-head-brand" href="/" aria-label="Policy Aligned home">
        <span className="piq-brand-mark is-small" aria-hidden="true">
          <Image src="/logo-icon.png" alt="" width={32} height={27} className="piq-brand-logo" />
        </span>
        <span className="piq-mobile-word">Policy Aligned</span>
      </Link>
      <span className="piq-spacer" />
      {sourcesPill}
      <button
      ...
      <div className="piq-chat">
        ...
        <header className="piq-chat-head">
          <Link className="piq-head-brand" href="/" aria-label="Policy Aligned home">
            ...
            <span className="piq-head-brand-word">Policy Aligned</span>
          </Link>
        ...
        <div className="piq-composer-wrap">
          ...
          <p className="piq-composer-note" id="composer-note">
            Policy Aligned can make mistakes — verify critical decisions against the cited source.
      ...
      <div className="piq-page-inner">
        ...
        {helpTab === "start" ? (
          <div className="piq-help-body">
            <p className="piq-lead">
              Policy Aligned answers real administrative scenarios using only your
        ...
        {helpTab === "trust" ? (
          <div className="piq-help-body">
            ...
            <p>
              Policy Aligned is designed to be used without student personal information. The
            ...
            <p>
              Policy Aligned runs on a small set of infrastructure providers, each bound by
